...
class OrderEventListener(EventListener):
    ...
    def register_create_order_listener(self, listener: typing.Callable):
        self.register_listener(CREATE_ORDER_CMD_KEY, listener)

    def register_update_order_listener(self, listener: typing.Callable):
        self.register_listener(UPDATE_ORDER_CMD_KEY, listener)

    def register_cancel_order_listener(self, listener: typing.Callable):
        self.register_listener(CANCEL_ORDER_CMD_KEY, listener)

    def register_order_created_listener(self, listener: typing.Callable):
        self.register_listener(ORDER_CREATED_EVENT_KEY, listener)

    def register_order_updated_listener(self, listener: typing.Callable):
        self.register_listener(ORDER_UPDATED_EVENT_KEY, listener)

    def register_order_canceled_listener(self, listener: typing.Callable):
        self.register_listener(ORDER_CANCELED_EVENT_KEY, listener)
