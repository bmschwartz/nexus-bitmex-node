...
class PositionEventListener(EventListener):
    ...
    def register_close_position_listener(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_CLOSE_CMD_KEY, listener, loop)

    def register_add_stop_to_position_listener(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_ADD_STOP_CMD_KEY, listener, loop)

    def register_add_tsl_to_position_listener(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_ADD_TSL_CMD_KEY, listener, loop)

    def register_position_closed_listener(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_CLOSED_EVENT_KEY, listener, loop)

    def register_added_stop_to_position_event(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_ADDED_STOP_EVENT_KEY, listener, loop)

    def register_added_tsl_to_position_event(self, listener: typing.Callable, loop):
        self.register_listener(POSITION_ADDED_TSL_EVENT_KEY, listener, loop)
